...
import { Calendar, CheckCircle, Droplets, Filter, MapPin, Plus, User, Clock } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import {  useCancelBloodRequestMutation, useGetMyBloodRequestsQuery } from "@/redux/features/bloodRequest/requestApi";
...
const RequestHistorySection = () => {
  ...
  const [cancelRequest, {isLoading:isCancelling}] = useCancelBloodRequestMutation()
 const handleCancelRequest = async(id:string) => {
  ...
  if (isError) {
    return <div className="text-center py-10 text-red-500">Error loading requests!</div>;
  }
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <Badge 
                        className={
                          ...
                          request.status === "Accepted" ? "bg-blue-500 hover:bg-blue-600" :
                          request.status === "Rejected" ? "bg-red-500 hover:bg-red-600" :
                          request.status === "Cancelled" ? "bg-gray-500 hover:bg-gray-600" :
                    ...
                    <div className="space-y-2">
                      <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6 text-sm">
                        ...
                        <span className="flex items-center">
                          ...
                          Needed: {format(new Date(request.neededDate), "MMM dd, yyyy")}
                        </span>
                        <span className="flex items-center">
                      ...
                      <div className="text-sm text-muted-foreground">
                        <p><strong>Patient:</strong> {request.patientName} ({request.patientAge} years)</p>
                  ...
                  <div className="flex flex-row lg:flex-col items-center lg:items-end gap-3">
                    ...
                    <div className="flex flex-col md:flex-row lg:flex-col space-y-2 md:space-y-0 md:space-x-2 lg:space-x-0 lg:space-y-2">
                      ...
                      {request.status === "Pending" && (
                        ...
                        size="sm" variant="outline" className="text-xs bg-transparent text-red-500">
