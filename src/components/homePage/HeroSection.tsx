    ...
    <section className="relative py-12 md:py-16 px-4 min-h-[90vh] flex items-center overflow-hidden bg-red-50/30">
      ...
      <div className="container mx-auto text-center">
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <h1 className="text-5xl md:text-7xl font-extrabold mb-4 bg-gradient-to-r from-red-600 via-red-700 to-red-800 bg-clip-text text-transparent">
        ...
        <div className="relative max-w-2xl mx-auto p-1 bg-gradient-to-br from-red-200 via-red-100 to-red-200 rounded-3xl shadow-2xl shadow-red-500/10">
            <div className="bg-white/90 backdrop-blur-md rounded-[22px] p-8 md:p-12 transition-all duration-500">
              ...
              {/* step === 0 এর কোড ব্লকটি এখানে থেকে সম্পূর্ণ মুছে ফেলা হয়েছে */}
              ...
              {step === 1 && (
                <div>
                  ...
                  {/* Animated Question */}
                  <div key={currentQuestionIndex} className="animate-in fade-in slide-in-from-right-10 duration-500">
                  ...
                  {isEligible ? (
                    <>
                      ...
                      <p className="text-gray-600 text-lg mb-8">
                        আপনার এই মহৎ উদ্যোগ পারে একটি জীবন বাঁচাতে। এখনই আমাদের সাথে যোগ দিন।
                      </p>
                      <Link to="/register">
                    ...
                    <>
                      ...
                      <p className="text-gray-600 text-lg mb-8">
                        আপনি রক্তদান করতে না পারলেও, আমাদের এই বার্তাটি শেয়ার করে অন্যের জীবন বাঁচাতে সাহায্য করতে পারেন।
                      </p>
                       <Link to="/share-campaign">
                        <button className="w-full max-w-sm h-16 text-xl bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 shadow-lg text-white rounded-xl font-bold transition-transform transform hover:scale-105 active:scale-100">
                          অন্যদের উৎসাহিত করুন
                        </button>
                      </Link>
                    </>
                  )}
                  <button onClick={resetQuiz} className="mt-6 text-sm text-gray-600 hover:underline">
                    আবার চেষ্টা করবেন?
                  </button>
                </div>
              )}
