...
const stats = [
  { icon: Users, label: "নিবন্ধিত রক্তদাতা", value: "৫০,০০০+", color: "text-blue-600 bg-blue-50" },
  { icon: Heart, label: "সফল রক্তদান", value: "২৫,০০০+", color: "text-red-600 bg-red-50" },
  { icon: MapPin, label: "জেলা কভারেজ", value: "৬৪", color: "text-green-600 bg-green-50" },
  { icon: Award, label: "জীবন বাঁচানো", value: "৭৫,০০০+", color: "text-purple-600 bg-purple-50" },
]
...
const features = [
  {
    ...
    description: "সকল রক্তদাতার তথ্য যাচাই করা এবং নিরাপদ। আমরা প্রতিটি রক্তদাতার পরিচয় যাচাই করি।",
  },
  {
    icon: Clock,
    title: "২৪/৭ সেবা",
    description: "দিন-রাত ২৪ ঘন্টা সেবা প্রদান। জরুরি প্রয়োজনে যেকোনো সময় রক্তদাতা খুঁজে পান।",
  },
  {
    icon: Target,
    title: "দ্রুত ম্যাচিং",
    description: "উন্নত অ্যালগরিদম ব্যবহার করে দ্রুততম সময়ে উপযুক্ত রক্তদাতা খুঁজে বের করি।",
  },
  {
    icon: TrendingUp,
    title: "ক্রমাগত উন্নতি",
    description: "ব্যবহারকারীদের মতামতের ভিত্তিতে আমরা ক্রমাগত আমাদের সেবার মান উন্নত করছি।",
  },
]
...
const milestones = [
  ...
  { year: "২০২৪", event: "AI ইন্টিগ্রেশন", description: "কৃত্রিম বুদ্ধিমত্তা যুক্ত করা" },
]
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <h3 className="text-3xl font-bold mb-4 text-gray-800">আমাদের অর্জন</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <Card className="h-full border-0 shadow-lg">
                ...
                <CardContent className="space-y-4">
                  <p className="text-gray-700 leading-relaxed">
                    আমাদের মিশন হলো বাংলাদেশে রক্তদানের সংস্কৃতি গড়ে তোলা এবং প্রযুক্তির মাধ্যমে রক্তের প্রাপ্যতা নিশ্চিত করা। আমরা চাই প্রতিটি
                    মানুষ যেন সময়মতো রক্ত পেতে পারে।
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span className="text-gray-700">সহজ এবং দ্রুত রক্তদাতা খোঁজার ব্যবস্থা</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span className="text-gray-700">নিরাপদ এবং যাচাইকৃত রক্তদাতা নেটওয়ার্ক</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span className="text-gray-700">রক্তদানে সচেতনতা বৃদ্ধি</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
            ...
            >
              <Card className="h-full border-0 shadow-lg">
                ...
                <CardContent className="space-y-4">
                  <p className="text-gray-700 leading-relaxed">
                    আমাদের ভিশন হলো এমন একটি বাংলাদেশ গড়া যেখানে রক্তের অভাবে কোনো মানুষের মৃত্যু হবে না। আমরা স্বপ্ন দেখি একটি সুস্থ ও
                    সমৃদ্ধ জাতির।
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span className="text-gray-700">দেশের প্রতিটি জেলায় রক্তদাতা নেটওয়ার্ক</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span className="text-gray-700">AI চালিত স্মার্ট রক্তদান ব্যবস্থা</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span className="text-gray-700">আন্তর্জাতিক মানের সেবা প্রদান</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h3 className="text-3xl font-bold mb-4 text-gray-800">আমাদের যাত্রা</h3>
              ...
              >
                <div className="flex-1">
                  <Card className="border-0 shadow-lg">
                    <CardContent className="p-6">
                      <Badge className="bg-red-600 text-white mb-3">{milestone.year}</Badge>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h3 className="text-3xl font-bold mb-4 text-gray-800">আমাদের টিম</h3>
