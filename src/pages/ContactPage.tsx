...
const faqItems = [
  {
    ...
    answer:
      "আমাদের প্ল্যাটফর্মে সহজেই নিবন্ধন করে রক্তদাতা হিসেবে যুক্ত হতে পারেন।",
  },
  {
  ...
  },
  {
    ...
    answer:
      "আমরা যত দ্রুত সম্ভব উপযুক্ত রক্তদাতার তথ্য প্রদান করার চেষ্টা করি।",
  },
  {
...
const ContactPage = () => {
        ...
        >
          <Card className="text-center shadow-2xl border-0 bg-white/95 backdrop-blur-sm overflow-hidden relative">
            ...
            <CardContent className="p-8 relative">
              ...
              >
                আপনার বার্তা সফলভাবে পাঠানো হয়েছে। আমি শীঘ্রই আপনার সাথে
                যোগাযোগ করব।
              </motion.p>
  ...
  return (
    <>
      <title>যোগাযোগ করুন | RoktoShare - জরুরি রক্তসেবায় আপনার পাশে</title>
      <meta
        name="description"
        content="RoktoShare-এর সাথে যোগাযোগ করুন। রক্তদান সংক্রান্ত যেকোনো প্রশ্ন, জরুরি রক্তের প্রয়োজনে সহায়তা, বা পরামর্শের জন্য আমাদের ফোন করুন, ইমেইল করুন অথবা বার্তা পাঠান।"
      />
      <meta
        name="keywords"
        content="যোগাযোগ, RoktoShare contact, রক্তদান সেবা, জরুরি রক্ত, ফোন নম্বর, ইমেইল, ব্লাড ডোনেশন হেল্পলাইন, শেরপুর, বাংলাদেশ"
      />
        ...
        <section className="py-16 px-4 relative z-10">
          <div className="container mx-auto text-center">
            ...
            >
              ...
              >
                রক্তদান সেবায় আপনার যেকোনো প্রশ্ন, পরামর্শ বা সহায়তার জন্য আমি
                এখানে আছি। একসাথে আমরা জীবন বাঁচানোর এই মহৎ কাজে এগিয়ে চলি।
              </motion.p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-600">
                আপনার সুবিধামতো যেকোনো মাধ্যমে যোগাযোগ করুন
              </p>
            </motion.div>
              ...
              >
                <Card className="shadow-2xl border-0 bg-white/90 backdrop-blur-sm overflow-hidden relative">
                  ...
                  <CardHeader>
                    ...
                    <CardDescription>
                      আপনার প্রশ্ন বা মতামত আমাকে জানান
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            className={`form-input transition-all duration-300 focus:ring-2 focus:ring-red-500 ${
                              errors.name
                                ? "border-red-500"
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          className={`form-input transition-all duration-300 focus:ring-2 focus:ring-red-500 resize-none ${
                            errors.message
                              ? "border-red-500"
                              : "border-gray-200 focus:border-red-500"
                          }`}
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            রক্তদানের মাধ্যমে জীবন বাঁচানো এবং মানবিক সেবা
                            প্রদান করা।
                          </p>
                        </div>
                      </div>
