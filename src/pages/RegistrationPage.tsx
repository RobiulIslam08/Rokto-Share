...
//     }, 3000)
//     console.log("form data from registration form", formData)
//   }
...
import { Heart, User, Mail, Lock, Phone, MapPin, Eye, EyeOff, ArrowLeft, CheckCircle } from "lucide-react"
import { motion } from "framer-motion"
// react-router-dom থেকে Link ইম্পোর্ট সরানো হয়েছে

// ডেটা সরাসরি কম্পোনেন্টে যোগ করা হয়েছে
...
const upazilas = {
    ...
    // ... অন্যান্য জেলার উপজেলা এখানে যোগ করতে হবে
}
...
const formSchema = z
  .object({
    ...
    phone: z.string().regex(/^01[3-9]\d{8}$/, { message: "সঠিক বাংলাদেশি ফোন নম্বর দিন" }),
    password: z.string().min(8, { message: "পাসওয়ার্ড কমপক্ষে ৮ অক্ষরের হতে হবে" }),
    confirmPassword: z.string(),

    // Step 2: Donor Info
    bloodGroup: z.string({ required_error: "রক্তের গ্রুপ নির্বাচন করুন" }),
    age: z
      .string()
      .refine((val) => !isNaN(parseInt(val, 10)), { message: "বয়স সংখ্যায় দিন" })
      .refine((val) => parseInt(val, 10) >= 18 && parseInt(val, 10) <= 65, {
        message: "বয়স ১৮-৬৫ বছরের মধ্যে হতে হবে",
      }),
    weight: z
      .string()
      .refine((val) => !isNaN(parseInt(val, 10)), { message: "ওজন সংখ্যায় দিন" })
      .refine((val) => parseInt(val, 10) >= 45, { message: "ওজন কমপক্ষে ৪৫ কেজি হতে হবে" }),
    ...
    // Step 3: Agreements
    agreeTerms: z.boolean().refine((val) => val === true, { message: "শর্তাবলী মেনে নিতে হবে" }),
    agreePrivacy: z.boolean().refine((val) => val === true, { message: "গোপনীয়তা নীতি মেনে নিতে হবে" }),
...
const step1Fields: (keyof z.infer<typeof formSchema>)[] = ["name", "email", "phone", "password", "confirmPassword"]
const step2Fields: (keyof z.infer<typeof formSchema>)[] = ["bloodGroup", "age", "weight"]
const step3Fields: (keyof z.infer<typeof formSchema>)[] = ["division", "district", "upazila", "agreeTerms", "agreePrivacy"]
...
const RegistrationPage = () => {
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    setIsLoading(true)
    console.log("Form data from registration form:", data)
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormControl>
                        <div className="relative">
                            <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                            <Input placeholder="আপনার পূর্ণ নাম লিখুন" {...field} className="pl-10 h-12 border-red-200 focus:border-red-400" />
                        </div>
                    </FormControl>
                    <FormMessage />
                </FormItem>
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormControl>
                        <div className="relative">
                            <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                            <Input type="email" placeholder="আপনার ইমেইল ঠিকানা" {...field} className="pl-10 h-12 border-red-200 focus:border-red-400" />
                        </div>
                    </FormControl>
                    <FormMessage />
                </FormItem>
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormControl>
                         <div className="relative">
                            <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                            <Input type="tel" placeholder="01XXXXXXXXX" {...field} className="pl-10 h-12 border-red-200 focus:border-red-400" />
                        </div>
                    </FormControl>
                    <FormMessage />
                </FormItem>
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormControl>
                         <div className="relative">
                            <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                            <Input type={showPassword ? "text" : "password"} placeholder="কমপক্ষে ৮ অক্ষরের পাসওয়ার্ড" {...field} className="pl-10 pr-10 h-12 border-red-200 focus:border-red-400" />
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormControl>
                        <div className="relative">
                            <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                            <Input type={showConfirmPassword ? "text" : "password"} placeholder="পাসওয়ার্ড আবার লিখুন" {...field} className="pl-10 pr-10 h-12 border-red-200 focus:border-red-400" />
  ...
  const renderStep2 = () => (
    <div className="space-y-4">
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Input type="number" placeholder="২৫" min="18" max="65" {...field} className="h-12 border-red-200 focus:border-red-400"/>
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                )}
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Input type="number" placeholder="৬০" min="45" {...field} className="h-12 border-red-200 focus:border-red-400"/>
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                )}
        ...
        <FormField
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormControl>
                        <Input type="date" {...field} className="h-12 border-red-200 focus:border-red-400" />
                    </FormControl>
                    <p className="text-xs text-gray-500">যদি আগে কখনো রক্তদান না করে থাকেন তাহলে খালি রাখুন</p>
                    <FormMessage />
                </FormItem>
        ...
        />
        <div className="bg-blue-50 p-4 rounded-lg">
            <h4 className="font-medium text-blue-800 mb-2 flex items-center gap-2">গুরুত্বপূর্ণ তথ্য</h4>
            <ul className="text-sm text-blue-700 space-y-1">
                <li>• রক্তদানের জন্য আপনার বয়স ১৮-৬৫ বছরের মধ্যে হতে হবে</li>
                <li>• ওজন কমপক্ষে ৪৫ কেজি হতে হবে</li>
                <li>• শেষ রক্তদানের ৯০ দিন পর আবার রক্তদান করতে পারবেন</li>
  ...
  const renderStep3 = () => {
    const availableUpazilas = upazilas[watchedDistrict as keyof typeof upazilas] || [];
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <Select onValueChange={(value) => {
                            ...
                            <FormControl>
                                <SelectTrigger className="h-12 w-full border-red-200 focus:border-red-400"><SelectValue placeholder="বিভাগ নির্বাচন করুন" /></SelectTrigger>
                            </FormControl>
                            <SelectContent>
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <Select onValueChange={(value) => {
                            ...
                            <FormControl>
                                <SelectTrigger className="h-12 w-full border-red-200 focus:border-red-400"><SelectValue placeholder="জেলা নির্বাচন করুন" /></SelectTrigger>
                            </FormControl>
                            <SelectContent>
                                {districts[watchedDivision as keyof typeof districts]?.map((district) => (<SelectItem key={district} value={district}>{district}</SelectItem>))}
                            </SelectContent>
                        </Select>
                        <FormMessage />
                    </FormItem>
                ...
                render={({ field }) => (
                    <FormItem>
                        <FormLabel>উপজেলা/থানা *</FormLabel>
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            <FormControl>
                                <SelectTrigger className="h-12 w-full border-red-200 focus:border-red-400"><SelectValue placeholder="উপজেলা নির্বাচন করুন" /></SelectTrigger>
                            </FormControl>
                            <SelectContent>
                                {availableUpazilas.map((upazila) => (<SelectItem key={upazila} value={upazila}>{upazila}</SelectItem>))}
                            </SelectContent>
                        </Select>
                        <FormMessage />
                    </FormItem>
                    ...
                    render={({ field }) => (
                        <FormItem className="flex items-start space-x-3 space-y-0">
                            ...
                            <div className="space-y-1 leading-none">
                                <FormLabel>আমি <a href="/terms" className="text-red-600 hover:underline">ব্যবহারের শর্তাবলী</a> পড়েছি এবং মেনে নিচ্ছি *</FormLabel>
                                <FormMessage />
                            </div>
                        </FormItem>
                    )}
                    ...
                    render={({ field }) => (
                        <FormItem className="flex items-start space-x-3 space-y-0">
                            <FormControl>
                             ...
                             <div className="space-y-1 leading-none">
                                <FormLabel>আমি <a href="/privacy" className="text-red-600 hover:underline">গোপনীয়তা নীতি</a> পড়েছি এবং মেনে নিচ্ছি *</FormLabel>
                                <FormMessage />
                            </div>
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="flex items-start space-x-3 space-y-0">
                            ...
                            <FormLabel>জরুরি রক্তের প্রয়োজনে আমাকে নোটিফিকেশন পাঠান (সুপারিশকৃত)</FormLabel>
                        </FormItem>
                    )}
                />
            </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex items-center justify-center p-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="w-full max-w-2xl">
        <a href="/" className="inline-flex items-center text-gray-600 hover:text-red-600 mb-6 transition-colors">
          <ArrowLeft className="w-4 h-4 mr-2" />
          হোমে ফিরে যান
        </a>
        <Card className="shadow-2xl border-0 bg-white/90 backdrop-blur-sm">
          <CardHeader className="text-center pb-4">
            ...
            <div className="flex items-center justify-center mt-6 space-x-4">
              {[1, 2, 3].map((step) => (
                <div key={step} className="flex items-center">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold ${step <= currentStep ? "bg-red-600 text-white" : "bg-gray-200 text-gray-500"}`}>
                    {step < currentStep ? <CheckCircle className="w-4 h-4" /> : step}
                  </div>
                  {step < 3 && <div className={`w-12 h-1 mx-2 ${step < currentStep ? "bg-red-600" : "bg-gray-200"}`} />}
                </div>
          ...
          <CardContent className="space-y-6">
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <div className="flex justify-between pt-6">
                  {currentStep > 1 && (
                    <Button type="button" variant="outline" onClick={() => setCurrentStep(currentStep - 1)} className="border-red-200 text-red-600 hover:bg-red-50">
                      পূর্ববর্তী
                    </Button>
                  )}
                  {currentStep < 3 ? (
            ...
            <div className="text-center pt-4 border-t">
              <p className="text-gray-600">
                ইতিমধ্যে অ্যাকাউন্ট আছে?{" "}
                <a href="/login-page" className="text-red-600 hover:text-red-700 font-semibold hover:underline">
                  লগইন করুন
                </a>
              </p>
            </div>
